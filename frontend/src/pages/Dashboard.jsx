              ...
              >
                ...
                <div className="space-y-4">
                  <div className="p-3 rounded-lg bg-white/5 border border-white/5">
                    ...
                    <p className="text-xs opacity-70">Burnout probability increased to 26%.</p>
                  </div>
                  <div className="p-3 rounded-lg bg-white/5 border border-white/5 opacity-50">
                    <p className="text-[10px] terminal-text text-[#b9cacb] mb-1">SYNC_COMPLETE</p>
                    <p className="text-xs">Predictive mesh successfully updated.</p>
                  </div>
                </div>
              </motion.div>
            )}
            ...
            {showProfileMenu && (
              ...
              >
                <div className="flex items-center gap-4 mb-6">
                  <div className="w-12 h-12 rounded-lg flex items-center justify-center font-bold text-lg" style={{ background:'rgba(0,219,231,0.1)', color:'#e1fdff', border: '1px solid rgba(0,219,231,0.2)' }}>
                    {(user?.displayName || 'A')[0].toUpperCase()}
                  </div>
                  <div>
                    <h4 className="text-sm font-bold text-[#e1fdff]">{user?.displayName || 'Authorized User'}</h4>
                    <p className="text-[9px] terminal-text opacity-50">{user?.email}</p>
                  </div>
                </div>
                <div className="h-px w-full bg-white/10 mb-4" />
                <div className="space-y-2">
                  {['Account Settings', 'Preferences', 'Neural Sync Settings'].map(item => (
