                ...
                >
                  ...
                  <div className="space-y-4">
                    <div className="p-3 rounded-lg bg-white/5 border border-white/5">
                      <p className="text-[10px] terminal-text text-[#ffb4ab] mb-1">CRITICAL_ANOMALY</p>
                      <p className="text-xs opacity-70">Engineering Dept: Burnout threshold exceeded in 45 nodes.</p>
                    </div>
                  </div>
                </motion.div>
              )}
